...
import { FileText, Scale, Users, CreditCard, AlertCircle, Shield, CheckCircle, XCircle } from 'lucide-react'
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-2xl">{c.generalTerms.title}</CardTitle>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-2xl">{c.merchantTerms.title}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-8">
