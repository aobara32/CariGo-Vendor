          ...
          <div className="max-w-4xl mx-auto">
            <div className="space-y-12">
              ...
              <div className="border-t pt-8">
                <h2 className="text-2xl font-semibold mb-6">{c.additionalPolicies.refunds.title}</h2>
                <div className="space-y-4">
              ...
              <div className="border-t pt-8">
                <h2 className="text-2xl font-semibold mb-6">{c.additionalPolicies.cookies.title}</h2>
                <div className="space-y-4">
